    ...
    <>
      ...
      <Layout>
        ...
        <>
          <ScrollToTop />
          <HeroSection
            tagline="Raise the Bar with"
            title="POSApt’s Bar POS System"
            desc="Make your bar shine with a complete bar solution. A bar POS system is a friendly interface for your bartender to manage orders and track sales. Give your traditional system a break and try advanced cloud-based point-of-sale software."
            imgUrl="assets/dist/image/ServicesImages/bar.webp"
          />
