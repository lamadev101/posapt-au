              ...
              <div className="row align-items-center justify-content-center gy-5">
                  ...
                  <div className="row">
                    <div className="heading_s1">
                      <span className="sub_heading font_style1">
                        <small>The Choice of Thriving Retail Businesses</small>
                      </span>
                      <h1 className=" fw-bold text-capitalize">
                        POSApt Retail POS System
                      </h1>
                    </div>
                  </div>
                  <div className="subpara mt-3">
                    <p className="text-center">
                      A retail POS system helps you automate business processes including inventory management, order management, customer data tracking, and sales reporting. Improve your monthly sales with better customer satisfaction by streamlining your business operations.
                ...
                <div className="col-md-6 ">
                  <div className="serv_left">
                    <img
                      src="assets/dist/image/ServicesImages/retails.webp"
                      className="img-fluid"
                      alt="Best Retail POS System"
                      title="Best Retail POS System"
                    />
                  </div>
                </div>
              </div>
