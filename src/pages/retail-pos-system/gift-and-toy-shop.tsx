...
const GiftToyShop = () => {
  ...
  const giftToyShopData = [
    {
      title: `Barcode Scanning`,
      describe: `POSApt allows you to easily scan barcodes on toys and gifts with a barcode scanner for quick and accurate checkout. This reduces the chances of pricing errors and speeds up the transaction process. Your customers will no longer have to wait in long queues to surprise their loved ones with lovely gifts.`
    },
    {
            ...
            <div className="row bg-light p-2 p-md-5">
              <div className="col-md-6">
                <div className="new-list ">
                  <div className="heading_s1 hs2  text-start">
                    <h2 className="fw-bold text-capitalize mb-3">An Advanced Gift & Toy Shop POS for <span className="text-theme">Australian Businesses</span></h2>
                    <p>Whether you run a gift shop, toy store, or souvenir shop, managing your store can be a challenge. This is especially true if you have multiple locations or sell online and in-person.
                    </p>
                    <p>You need a reliable system that can handle all of your business tasks, even during peak times. That's where POSApt's Gift & Toy Shop POS System comes in. It's designed to simplify operations, even during busy shopping periods. It brings order to the ever-changing world of gift and toy retail.
                    </p>
                    <p>Embark on a new era of gift and toy retail. From seamless operations to enhanced customer experiences, we're ready to empower your business like never before. Take the first step and start your journey with our 30-day trial today. Embrace the future of gift and toy store management.</p>
                  </div>
              ...
              <div className="col-md-12">
                <div className="subpara mt-3 productcard">
                  <div className="row">
                    {giftToyShopData.map((item, index) => (
              ...
              <div className="col-md-6">
                <div className="new-list ">
                  <div className="heading_s1 hs2  text-start">
                    ...
                    {giftToyShopData1.map((item, index) => (
