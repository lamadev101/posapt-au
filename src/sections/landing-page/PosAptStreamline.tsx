          ...
          <div className="col-md-7">
            <div className="">
              ...
              <ul className="newposlist text-dark fw-bold pt-4 fs-5">
                ...
                <li>
                  <a href="oos.html" className="text-theme">
                    <svg
                      className="me-2"
                      xmlns="http://www.w3.org/2000/svg"
                      xmlnsXlink="http://www.w3.org/1999/xlink"
                ...
                <li>
                  <a href="cloudpos.html" className="text-theme">
                    <svg
                      className="me-2"
                      xmlns="http://www.w3.org/2000/svg"
                      xmlnsXlink="http://www.w3.org/1999/xlink"
              ...
              <p className="fs-5 mt-2 mt-md-5">
                POSapt is the cutting-edge POS system integrated E-commerce website.
                Business can manage both in shop and online sales within single
                system. This synchronization simplifies inventory management, order
                processing, and ensures consistent product information across all
                channels. Manage business smarter and save time.
              </p>
            </div>
          </div>
...
export default PosAptStreamline